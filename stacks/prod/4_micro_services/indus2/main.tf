...
resource "aws_s3_bucket" "thehive_results" {
  bucket = "recrd-thehive-results"
...
resource "aws_s3_bucket_public_access_block" "thehive_results" {
  bucket = aws_s3_bucket.thehive_results.id
...
#       "s3:DeleteObject"
#     ]
#     resources = ["${aws_s3_bucket.valossa_results.arn}/*", "${aws_s3_bucket.thehive_results.arn}/*"]
#   }
#   statment {
#   actions=[
#
